...
| [`CALIBRATION_FREEZE_2026-07-23.md`](CALIBRATION_FREEZE_2026-07-23.md) | **The current freeze** (HISTORICAL — the ACTIVE freeze is `calib-freeze-2026-07-27` = `0582633`, see WALK_PREFLIGHT). What every walk's code is pinned to, the build-stamp verification rules, and the collection-round promotion gates. Supersedes the retired 07-18/07-18b freezes and preserves their tag→commit mapping. |
